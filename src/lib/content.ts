...
const en = {
  ...
  partners: {
    ...
    items: [
      ...
      { name: "Packeta", sector: "European logistics" },
      { name: "\u010cesk\u00e1 spo\u0159itelna", sector: "Financial services" },
      { name: "Kiwi.com", sector: "Travel technology" },
      { name: "\u0160koda Auto", sector: "Automotive" },
      { name: "Alza.cz", sector: "E-commerce" },
      { name: "Seznam.cz", sector: "Internet & media" },
      { name: "Rohlik Group", sector: "Online grocery" },
    ],
  },
  cta: {
    eyebrow: "Engage",
...
const fr: DeepPartial<Content> = {
  ...
  partners: {
    ...
    items: [
      ...
      { sector: "Technologies du voyage" },
      { sector: "Automobile" },
      { sector: "E-commerce" },
      { sector: "Internet & m\u00e9dias" },
      { sector: "\u00c9picerie en ligne" },
    ],
  },
  cta: {
    eyebrow: "Collaborer",
