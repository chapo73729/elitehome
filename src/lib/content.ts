...
const en = {
  ...
  partners: {
    ...
    items: [
      { name: "Gjirafa", sector: "AI & digital platforms \u00b7 Kosovo" },
      ...
      { name: "Facilization", sector: "Banking technology \u00b7 Albania" },
...
const fr: DeepPartial<Content> = {
  ...
  partners: {
    ...
    items: [
      { sector: "IA & plateformes num\u00e9riques \u00b7 Kosovo" },
      ...
      { sector: "Technologie bancaire \u00b7 Albanie" },
