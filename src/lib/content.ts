...
const en = {
  ...
  partners: {
    ...
    items: [
      { name: "Vltava Energo", sector: "Energy & grid" },
      { name: "Hradek Logistika", sector: "European logistics" },
      { name: "Koruna Capital", sector: "Financial services" },
      { name: "Orloj Systems", sector: "Real-time payments" },
      { name: "Letn\u00e1 Aero", sector: "Aerospace manufacturing" },
      { name: "Moravit", sector: "Industrial materials" },
      { name: "Kyberna", sector: "Cybersecurity" },
      { name: "Zdravota", sector: "Healthcare" },
    ],
  },
  cta: {
    eyebrow: "Engage",
...
const fr: DeepPartial<Content> = {
  ...
  partners: {
    ...
    items: [
      ...
      { sector: "Logistique europ\u00e9enne" },
      { sector: "Services financiers" },
      { sector: "Paiements temps r\u00e9el" },
      { sector: "A\u00e9ronautique" },
      { sector: "Mat\u00e9riaux industriels" },
