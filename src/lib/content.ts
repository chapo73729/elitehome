...
const en = {
  ...
  game: {
    eyebrow: "Interlude · Core Defense",
    title: "Hold the core.",
    intro: "Threats close in. Neutralise them before they reach the core. Ours run 24/7 — how long can you hold?",
    play: "Initialize",
    replay: "Run it again",
    hudScore: "Neutralised",
    hudIntegrity: "Core integrity",
    best: "Best",
    bestWaveLabel: "Top wave",
    topRuns: "Top runs",
    challenge: "Challenge a friend",
    challengeCopied: "Challenge copied — send it.",
    challengeText: "I held wave {wave} with {score} neutralised on ARDLABS Core Defense. Beat me: {url}",
    over: "Core breached.",
    ctaLine: "We engineer defence like this — for real, at scale.",
    cta: "Start a project",
    hint: "Click or tap the incoming threats.",
    hudWave: "Wave",
    hudCombo: "Combo",
    pulse: "Pulse",
    pulseHint: "Pulse — clears nearby threats · Space",
    countdownGo: "Defend",
    rankLabel: "Clearance",
    ranks: ["Recruit", "Field Engineer", "Senior", "Architect", "Principal"],
    overclock: "Overclock",
    purge: "Purge",
    diffLabel: "Threat level",
    diffNormal: "Standard",
    diffHard: "Hardened",
    upgradeTitle: "System upgrade",
    upgradeSub: "Choose a subsystem to reinforce.",
    perfect: "Perfect wave",
    bossIn: "Breach attempt",
    bossDown: "Breach repelled",
    upgrades: [
      { name: "Reinforce", desc: "+25 max integrity, fully repaired" },
      { name: "Rapid systems", desc: "−30% ability cooldowns" },
      { name: "Sentry tuning", desc: "+65% turret fire rate" },
      { name: "Wide array", desc: "+35% neutralise radius" },
      { name: "Overcharge", desc: "Pulse reach & speed +40%" },
    ],
  },
  contact: {
    eyebrow: "Contact · 06",
...
const fr: DeepPartial<Content> = {
  ...
  game: {
    eyebrow: "Interlude · Défense du noyau",
    title: "Tenez le noyau.",
    intro: "Les menaces convergent. Neutralisez-les avant qu'elles n'atteignent le noyau. Les nôtres tournent 24/7 — combien de temps tiendrez-vous ?",
    play: "Initialiser",
    replay: "Rejouer",
    hudScore: "Neutralisées",
    hudIntegrity: "Intégrité du noyau",
    best: "Record",
    bestWaveLabel: "Vague max",
    topRuns: "Meilleures parties",
    challenge: "Défier un ami",
    challengeCopied: "Défi copié — envoyez-le.",
    challengeText: "J'ai tenu la vague {wave} avec {score} menaces neutralisées sur ARDLABS Core Defense. Battez-moi : {url}",
    over: "Noyau percé.",
    ctaLine: "Nous concevons cette défense — pour de vrai, à l'échelle.",
    cta: "Démarrer un projet",
    hint: "Cliquez ou touchez les menaces entrantes.",
    hudWave: "Vague",
    hudCombo: "Combo",
    pulse: "Impulsion",
    pulseHint: "Impulsion — balaie les menaces proches · Espace",
    countdownGo: "Défendez",
    rankLabel: "Habilitation",
    ranks: ["Recrue", "Ingénieur terrain", "Senior", "Architecte", "Principal"],
    overclock: "Surrégime",
    purge: "Purge",
    diffLabel: "Niveau de menace",
    diffNormal: "Standard",
    diffHard: "Renforcé",
    upgradeTitle: "Amélioration système",
    upgradeSub: "Choisissez un sous-système à renforcer.",
    perfect: "Vague parfaite",
    bossIn: "Tentative de percée",
    bossDown: "Percée repoussée",
    upgrades: [
      { name: "Renforcer", desc: "+25 d'intégrité max, réparation totale" },
      { name: "Systèmes rapides", desc: "−30% de recharge des capacités" },
      { name: "Réglage sentinelle", desc: "+65% de cadence de tourelle" },
      { name: "Large spectre", desc: "+35% de rayon de neutralisation" },
      { name: "Surcharge", desc: "Portée & vitesse d'impulsion +40%" },
    ],
  },
  contact: {
    eyebrow: "Contact · 06",
